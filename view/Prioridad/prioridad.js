...
function editar(id_prioridad){
    ...
    $.post("../../controller/prioridad.php?op=mostrar", {id_prioridad : id_prioridad}, function (data) {
...
function eliminar(id_prioridad){
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.post("../../controller/prioridad.php?op=eliminar", {id_prioridad : id_prioridad}, function (data) {
